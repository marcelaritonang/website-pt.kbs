...
export default function Navbar() {
  ...
  // Improved scroll handler - simplified to just track scrolling for background change
  useEffect(() => {
  ...
  return (
    // Navbar akan selalu terlihat karena tidak ada lagi conditional rendering pada komponen Navbar
    <nav
