      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto mt-12">
          ...
          >
            ...
            />
            <div className="ml-4">
              <h3 className={`text-lg font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>{bimRenovationArticle.author}</h3>
              <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>{bimRenovationArticle.authorRole}</p>
            </div>
          </motion.div>
